  ...
  return (
    <div className='groups_container flex flex-col gap-y-4'>
      ...
      <div className='groups flex flex-col gap-y-6 max-h-[300px] overflow-auto scrollbar scrollbar-w-1 scrollbar-thumb-green-500 scrollbar-track-gray-100'>
        <div className='singe_group bg-gradient-to-r hover:from-neutral-900 hover:via-neutral-800 to-transparent transition-all flex font-plus_jakarta_sans justify-center items-center gap-x-5 text-[#E8E9E9] text-[16px] font-semibold p-3 rounded-lg'>
