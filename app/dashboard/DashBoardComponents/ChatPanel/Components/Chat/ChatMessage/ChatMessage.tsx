...
const ChatMessage = ({user_avatar, user_nickname, message}:MessageProps) => {
  return (
    <div className='chat_message flex gap-5 border-[1px] border-[#1A1D21] p-3 rounded-lg'>
         <UserAvatarWithStatus size='normal' user_avatar={user_avatar} user_status={{ with_dot: true, status: "ONLINE" }} modal_action={true} show_nick={false} reveal_mail={false} width='fit'/>
