...
const FriendsListWrapper = () => {
  ...
  return (
            <>
                <div id='user_list_with_statuses' className={` transition-all z-40 duration-300 ${friendListPanelStatus === true ? "opacity-100":"opacity-30"} min-w-full w-full md:min-w-[200px] md:w-[200px] bg-[#131619]  overflow-hidden flex flex-col justify-between gap-4 h-screen shadow-2xl shadow-black`}>
                ...
                {/* <ListVisibilitySetter friendsVisible/> */}
            </>
    )
}
