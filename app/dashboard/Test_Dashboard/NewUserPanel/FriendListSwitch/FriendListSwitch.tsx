...
const FriendListSwitch = () => {
  ...
  return (
    <div id='friend_list_switch' className='text-[#9B9C9E] flex items-center'>
        <div onClick={()=> dispatch(UI_VIEW_CHANGE({UI:"friendList_panel", status:!currentFriendPanelStatus}))} className='cursor-pointer offer flex flex-row-reverse justify-end gap-x-3 hover:bg-[#363A3D] transition-all px-2 py-2 rounded-sm'>
