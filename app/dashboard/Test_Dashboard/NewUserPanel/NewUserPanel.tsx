...
const NewUserPanel = () => {
  ...
  return (
    <section className={`bg-[#131619] relative shadow-2xl transition-all duration-300  shadow-black ${status === true && type === "user" ? "right-0 min-w-[200px]  md:w-[100%]":"right-full w-[0px]"} max-w-[70%] md:max-w-[200px] lg:max-w-[250px] flex flex-col items-center gap-y-3  h-[100vh]`}>
