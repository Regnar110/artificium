...
const GroupPanel = () => {
  ...
  return (
    <section className={`bg-[#131619] ${isRevealed === true ? "left-0":"left-[-250px]"} text-[#9B9C9E] font-plus_jakarta_sans transition-all duration-300 min-w-[250px] w-full md:w-[250px] relative  flex flex-col items-center gap-y-3  h-[100vh]`}>
