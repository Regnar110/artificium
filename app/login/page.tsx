  ...
  return (
    <main className='login_page bg-[#131619] grid grid-cols-2 w-full'>
      <div className='login_section relative grid grid-rows-3 w-full'>
        ...
        <div className='login_block grid grid-row-6 col-span-2 justify-self-center gap-10'>
          ...
          <form className='login_form flex flex-col gap-y-5'>
          ...
          <div className='signup flex gap-3 relative justify-self-start font-semibold text-[#686B6E]'>Don't have an accont?<span className='font-plus_jakarta_sans text-[16px] font-semibold text-transparent bg-clip-text gradient_dayblue_blue_green500'>Sign Up</span></div>    
        </div>
      </div>
      <div className='login_illustration relative w-full justify-self-end float-right'>
        <Image
          className='float-right object-contain h-[100vh] w-fit' 
          src={login_image}
          alt='login_image'
        />
      </div>
