...
const LoginButtons = () => {
  ...
  return (
    <div className='buttons_container flex flex-col sm:flex-row gap-4 sm:gap-8'>
        <Button onClick={() => session ? signOut() : NextAuthProviderLoginPopUpCenter('/provider-sign-in/google',"hdajsd") } className='px-5 whitespace-nowrap bg-[#1A1D21] text-[14px] text-[#686B6E] font-plus_jakarta_sans font-semibold flex gap-3 h-[48px]' variant='text' aria-label='google_login'>
