      ...
      <div className={`user_data flex flex-col w-fit h-fit `}>
        ...
        }
        {
          user_status?.with_text ? 
            (
              user_status.status === "ONLINE"? <span className='text-[#B6F09C] text-[10px] xl:text-[12px]'>{user_status.status}</span> : <span className='text-[#b83030] text-[10px] xl:text-[12px]'>{user_status.status}</span>
            )
          :
              null
          }        
